...
LANGUAGE_TEMPLATES = {
    ...
    "es": {
        "title_suffix": "Documentación",
        "desc": "Documentación oficial para desarrolladores y agentes de IA",
    },
    ...
    "fr": {
        ...
        "desc": "Documentation officielle pour les développeurs et les agents IA",
    },
...
class MultilingualLLMsGenerator:
    ...
    def generate_multilingual_bundle(
        ...
        for l in langs:
            meta = LANGUAGE_TEMPLATES.get(
                l, {"title_suffix": "Docs", "desc": f"{site_name} documentation in {l}"}
            )
        ...
        for l in langs:
            meta = LANGUAGE_TEMPLATES.get(
                l, {"title_suffix": "Documentation", "desc": f"{site_name} documentation in {l}"}
            )
            lines = [
